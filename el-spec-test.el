...
(ert-deftest el-spec:test-prepare-arglist ()
  (should (equal (el-spec:prepare-arglist "hoge")
                 '("hoge")))
  (should (equal (el-spec:prepare-arglist '("hoge" :vars (a b)))
                 '("hoge" :vars (a b))))
  (should (equal (el-spec:prepare-arglist '("hoge" :vars ((a 1) (b 1))))
                 '("hoge" :vars ((a 1) (b 1)))))
  (should (equal (el-spec:prepare-arglist nil)
                 '(nil)))
  (should (equal (el-spec:prepare-arglist '(:vars ((a 1) (b 1))))
                 '(nil :vars ((a 1) (b 1)))))
  (should (equal (el-spec:prepare-arglist '(nil :vars ((a 1) (b 1))))
                 '(nil :vars ((a 1) (b 1)))))
  (should-error (el-spec:prepare-arglist '(1 :vars ((a 1) (b 1)))))
  (should-error (el-spec:prepare-arglist 1))
  )
